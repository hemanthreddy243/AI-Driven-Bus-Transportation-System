  ...
  useEffect(() => {
    ...
    const initializeMap = async () => {
      try {
        ...
        // Remove time restriction for debugging
                  ...
                  <>
                    <div style={styles.routeInfo}>
                      ...
                      <ul style={styles.routeList}>
                        {busRoutes[Object.keys(busRoutes)[currentPage]].map((item, index) => (
  ...
  useEffect(() => {
    ...
    const initializeMap = async () => {
      try {
        ...
        // Render map based on current filter state
        const routesArray = Object.entries(data.routes);
    ...
    initializeMap();
  }, [currentTime, currentPage, showMyRouteOnly, studentInfo]); // Re-run on filter toggle
              ...
              <div style={styles.routesBox}>
                ...
                {totalPages > 0 ? (
                  ...
                  <p style={styles.infoText}>
                    {showMyRouteOnly ? "No route found for your stop." : "No routes yet. Check 5 PM - 6 PM."}
                  </p>
                )}
              </div>
            </div>
